...
(deffacts questions
    (question (id 1) (text "Anda ingin makanan manis?"))
    (question (id 2) (text "Apakah anda sedang dalam program diet?"))
    (question (id 3) (text "Apakah anda vegetarian?"))
    (question (id 4) (text "Apakah anda alergi pada kacang?"))
    (question (id 5) (text "Apakah anda alergi pada buah?"))
    (question (id 6) (text "Apakah anda menghindari gluten?"))
    (question (id 7) (text "Apakah anda suka cokelat?"))
    (question (id 8) (text "Apakah anda suka kue?"))
    (question (id 9) (text "Apakah anda suka makanan dingin?"))
    (question (id 10) (text "Apakah anda suka makanan bersantan?"))
    (question (id 11) (text "Apakah anda mengonsumsi telur?"))
    (question (id 12) (text "Apakah anda menghindari garam?"))
    (question (id 13) (text "Apakah anda suka makanan pedas?"))
    (question (id 14) (text "Apakah anda suka seafood?"))
    (question (id 15) (text "Apakah anda suka makanan berlemak?"))
    )
...
(defrule print-QA
    ...
    =>
    (printout t ?question ?answer crlf))
